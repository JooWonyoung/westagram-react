      ...
      <nav>
        <div className='nav-container'>
          ...
          <div className='serch-bar-container'>
            ...
            <img src='images/loupe.png' className='mgnifying-glass' alt='glass'/>
          </div>
          <div className='icon-container'>
            ...
            <img src='images/explore.png' className='explore icon' alt='explore' />
            <img src='https://s3.ap-northeast-2.amazonaws.com/cdn.wecode.co.kr/bearu/heart.png' className='heart icon' alt='love' />
            <img src='images/profile.jpg' className='profile icon' alt='profile'/>
          </div>
        </div>
      </nav>
